...
public class OutlayResponse {
    ...
    private List<OutlayStringView> strings;

    public OutlayResponse(Long id, Long outlayGroupId, String stringName, Long total, Long salary, Long mimExploitation, Long machineOperatorSalary, Long materials, Long mainCosts, Long supportCosts, Long equipmentCosts, Long overheads, Long estimatedProfit, Boolean isDeleted, List<OutlayStringView> strings) {
        this.id = id;
    ...
    public List<OutlayStringView> getStrings() {
        return this.strings;
    }
    ...
    public void setStrings(List<OutlayStringView> strings) {
        this.strings = strings;
    }
    ...
    public String toString() {
        return "OutlayResponse(id=" + this.getId() + ", outlayGroupId=" + this.getOutlayGroupId() + ", stringName=" + this.getStringName() + ", total=" + this.getTotal() + ", salary=" + this.getSalary() + ", mimExploitation=" + this.getMimExploitation() + ", machineOperatorSalary=" + this.getMachineOperatorSalary() + ", materials=" + this.getMaterials() + ", mainCosts=" + this.getMainCosts() + ", supportCosts=" + this.getSupportCosts() + ", equipmentCosts=" + this.getEquipmentCosts() + ", overheads=" + this.getOverheads() + ", estimatedProfit=" + this.getEstimatedProfit() + ", isDeleted=" + this.getIsDeleted() + ", strings=" + this.getStrings() + ")";
    }
    ...
    public static class OutlayResponseBuilder {
        ...
        public OutlayResponseBuilder strings(List<OutlayStringView> strings) {
            this.strings = strings;
            return this;
        }
